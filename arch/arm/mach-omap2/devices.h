...
int __init am335x_register_mcasp(struct snd_platform_data *pdata, int ctrl_nr); //CS: should I comment this out?
void __init am335x_register_mcasp0(struct snd_platform_data *pdata); //CS added
